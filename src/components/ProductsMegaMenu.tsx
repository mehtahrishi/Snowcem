                  ...
                  <div className="flex items-center space-x-1 shrink-0 ml-1">
                    <span
                      className={`text-[9px] px-1.5 py-0.2 rounded font-normal ${
                        isSelected ? "bg-white/20 text-white" : "text-slate-400 bg-gray-100"
                      }`}
                    >
                      {count}
                    </span>
              ...
              {groupedRanges.map(([rangeTitle, products], rIdx) => (
                <div key={rIdx} className="space-y-2">
                  ...
                  <div className="pb-1 border-b border-gray-100">
                    <h5 className="text-[11px] font-medium uppercase tracking-widest text-slate-500 font-label">
                      {rangeTitle}
                    </h5>
                  </div>
                  ...
                  <div className="space-y-2">
                    {products.map((prod) => (
                      <Link
                        ...
                        onClick={onClose}
                        className="group flex items-center space-x-3 p-2.5 rounded-xl border border-gray-100 bg-white hover:bg-gray-50 hover:border-[#D83E78]/50 transition-all duration-150"
                      >
                        {/* Product Packshot Thumbnail */}
                        <div className="w-12 h-12 rounded-lg bg-gray-50 border border-gray-100 p-1 flex items-center justify-center shrink-0 shadow-2xs group-hover:border-[#D83E78]">
                          {prod.image ? (
                            <img
                              src={prod.image}
                              alt={prod.name}
